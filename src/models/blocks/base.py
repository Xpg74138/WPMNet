...
class Upsample(nn.Module):
    ...
    def __init__(self, size, scale_factor, mode: str = "nearest"):
...
class FeatureRectifyModule(nn.Module):
    def __init__(self, dim, _, reduction=1, lambda_c=.5, lambda_s=.5):
...
class FeatureFusionModule(nn.Module):
    def __init__(self, dim, _,num_heads=None,reduction=1, norm_layer=nn.BatchNorm2d):
        super().__init__()
